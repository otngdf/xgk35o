...
insert into appdb.customers values (null,'Csodás Gasztro Kft.',1111,'Budapest','Kicsi utca 1.', 'csoda', SHA2('pass',512));
insert into appdb.customers values (null,'Nagy Ügyvédi Iroda',2222,'Budapest','Nagy utca 1.', 'nagy', SHA2('pass',512));
insert into appdb.customers values (null,'Kis cukrászda',3333,'Budapest','Kis utca 1.', 'kis', SHA2('pass',512));
insert into appdb.customers values (null,'Kocsma az it-sokhoz',4444,'Budapest','Google utca 1.', 'kocsma', SHA2('pass',512));
insert into appdb.customers values (null,'Privát nyomda',5555,'Budapest','Privát utca 1.', 'nyomda', SHA2('pass',512));
